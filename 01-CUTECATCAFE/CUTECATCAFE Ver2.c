...
// 배웠던 개념들로만 만들어본거라 쫌 비효율적일수도 있어요...
// 이건 이 코드쓰면 되는데? = 몰라서 안쓴거에요...ㅠㅠ
// 왜 그렇게 했어요? = 어떻게 하는지 몰라서요
// 작성자님이 알고 있는걸로도 충분히 구현가능한데? = 복잡해서 그렇게 생각못해봤어요
// if에 if에 if에 else에 다시 if에.. 으아아악!!!
// 프로그램언어를 아무것도 몰랐던 한 소녀가 GPT에게 2.5일간 배운것들 기록
// 깃허브 처음이라 어떻게 쓰는지 잘몰라요...
// 감삼다!!
// 2025. 12. 14. 기록

// 이번에 의미는 같지만 값은 다른것을 좀 더 간편하게 할 수 있는걸 배워서 새로운 버전으로 내봤어요
// 아마 다음에는 음 뭐가 더 있는지는 모르겠지만 또 바뀌면 ver3으로 찾아올게요 = ㅂ=//
// 2025. 12. 16. 기록
